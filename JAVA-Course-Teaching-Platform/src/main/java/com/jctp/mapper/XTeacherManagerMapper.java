...
public interface XTeacherManagerMapper {
	...
	List<User> listTeacher(RequestModel<User> reqModel);
	...
	@Insert("INSERT INTO JCTP_USER(role_id,phone,work_no,name,sex,state,password) values(2,#{phone},#{workNo},#{name},#{sex},1,"+Constants.MIMA+")")
