...
public class XCourseFileManagerServiceImpl implements XCourseFileManagerService{
	@Autowired
	private XCourseFileManagerMapper coursefileManagerMapper;
	...
	@Override
	@Transactional
	public ResponseModel<CourseFile> update(CourseFile coursefile) {
		ResponseModel<CourseFile> resModel=new ResponseModel<CourseFile>();
			coursefileManagerMapper.update(coursefile);
