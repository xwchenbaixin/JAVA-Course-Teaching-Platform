...
function initInsert(){
	$("#insertBtn").click(function(){
		$.ajax("/studentManager/xstuinsert",
		        {
		            ...
		            data:JSON.stringify({
		    			...
		    			"classId"	:	$("#insertStuClassId").val(),
		    			"phone"		:	$("#insertStuPhone").val(),
		            }),
...
function initUpdate(){
	$("#updateBtn").click(function(){
		$.ajax("/studentManager/xstuupdate",
		        {
		            dataType: "json", // 预期服务器返回的数据类型。
		            type: "POST", //  请求方式 POST或GET
		            crossDomain:true,  // 跨域请求
		            ...
		            data:JSON.stringify({
		    			...
		    			"classId"	:	$("#updateStuClassId").val(),
		    			"phone"		:	$("#updateStuPhone").val(),
		            }),
...
function initDelete(){
	$("#deleteBtn").click(function(){
		$.ajax("/studentManager/xstudelete",
		        {
		            dataType: "json", // 预期服务器返回的数据类型。
		            type: "POST", //  请求方式 POST或GET
		            crossDomain:true,  // 跨域请求
