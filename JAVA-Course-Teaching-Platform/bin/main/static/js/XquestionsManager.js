...
var operateEvents={
		"click #tableEditor":function(e,value,row,index){
			$("#updateQueId").val(row.id);
			$("#updateQueQuestionName").val(row.questionName);
			$("#updateQueQuestionType").val(row.questionType);
			$("#updateQueAnswer").val(row.answer);
			$("#updateQueSep").val(row.seq);
		},
