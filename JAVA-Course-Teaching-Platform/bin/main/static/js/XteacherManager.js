...
function initMainTable () {
    ...
    var queryUrl = '/teacherManager/listTeacher';
...
var operateEvents={
		"click #tableEditor":function(e,value,row,index){
			$("#updateTeaId").val(row.id);
			$("#updateTeaWorkNo").val(row.workNo);
			$("#updateTeaName").val(row.name);
			$("#updateTeaSex").val(row.sex);
			$("#updateTeaPhone").val(row.phone);
		},
...
function initInsert(){
	$("#insertBtn").click(function(){
		$.ajax("/teacherManager/xteainsert",
		        {
		            ...
		            data:JSON.stringify({
		            	//"id"		:	$("#updateStuId").val(),
		    			"workNo"	:	$("#insertTeaWorkNo").val(),
		    			"name"		:	$("#insertTeaName").val(),
		    			"sex"		:	$("#insertTeaSex").val(),
		    			"phone"		:	$("#insertTeaPhone").val(),
		            }),
...
function initUpdate(){
	$("#updateBtn").click(function(){
		$.ajax("/teacherManager/xteaupdate",
		        {
		            dataType: "json", // 预期服务器返回的数据类型。
		            type: "POST", //  请求方式 POST或GET
		            crossDomain:true,  // 跨域请求
		            ...
		            data:JSON.stringify({
		            	"id"		:	$("#updateTeaId").val(),
		    			"workNo"	:	$("#updateTeaWorkNo").val(),
		    			"name"		:	$("#updateTeaName").val(),
		    			"sex"		:	$("#updateTeaSex").val(),
		    			"phone"		:	$("#updateTeaPhone").val(),
		            }),
...
function initDelete(){
	$("#deleteBtn").click(function(){
		$.ajax("/teacherManager/xteadelete",
		        {
		            dataType: "json", // 预期服务器返回的数据类型。
		            type: "POST", //  请求方式 POST或GET
		            crossDomain:true,  // 跨域请求
